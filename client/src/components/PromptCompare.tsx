    ...
    >
      <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-xl font-bold text-white">Jämför texter</h2>
        </div>
      ...
      <Card className="bg-white/[0.02] border-white/[0.08] overflow-hidden">
        <div className="bg-purple-500/5 p-4 border-b border-white/[0.06]">
          <div className="flex flex-wrap items-center gap-4 text-sm">
            <div className="flex items-center gap-2">
              ...
              <div className="bg-white/10 text-white/70 text-xs px-2 py-1 rounded-md font-semibold">{stats.originalWords} ord</div>
            </div>
            <ArrowRight className="w-4 h-4 text-white/30" />
            <div className="flex items-center gap-2">
              <span className="text-white/50">Förbättrad:</span>
              <div className="bg-white/10 text-white/70 text-xs px-2 py-1 rounded-md font-semibold">{stats.improvedWords} ord</div>
            </div>
            <div className={`text-xs px-2 py-1 rounded-md font-semibold border ${stats.wordDiff > 0 ? "bg-emerald-500/20 text-emerald-400 border-emerald-500/30" : "bg-white/10 text-white/70"
              }`}>
          ...
          <div className="p-6 space-y-6">
            <div className="p-4 bg-red-500/10 rounded-lg border border-red-500/20">
              <div className="flex items-center gap-2 mb-2">
                <div className="w-3 h-3 rounded-full bg-red-400" />
                <span className="text-sm font-medium text-red-300">Originaltext</span>
              </div>
            ...
            <div className="p-4 bg-emerald-500/10 rounded-lg border border-emerald-500/20">
              <div className="flex items-center gap-2 mb-2">
                <div className="w-3 h-3 rounded-full bg-emerald-500" />
                <span className="text-sm font-medium text-emerald-300">Förbättrad text</span>
              </div>
        ...
        {(added.length > 0 || removed.length > 0) && (
          <div className="bg-white/[0.02] p-4 border-t border-white/[0.06]">
            <p className="text-sm font-medium text-white/60 mb-3">Viktiga ändringar:</p>
