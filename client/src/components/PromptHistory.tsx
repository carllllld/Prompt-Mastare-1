...
import { History, Clock, Copy, Check, ChevronDown, ChevronUp, AlertCircle } from "lucide-react";
  ...
  return (
    <Card className="p-6 bg-white/[0.02] border-white/[0.08]">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h3 className="text-lg font-bold text-white">Prompthistorik</h3>
        <Badge className="bg-violet-500/20 text-violet-300 border-violet-500/30 ml-2">Pro</Badge>
      </div>
