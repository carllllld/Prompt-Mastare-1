...
export function PromptFormProfessionalClean({ onSubmit, isPending, disabled }: PromptFormProps) {
      ...
      <form onSubmit={form.handleSubmit(onLocalSubmit)} className="space-y-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-4 bg-gray-100 border border-gray-200">
            <TabsTrigger value="basic" className="data-[state=active]:bg-white data-[state=active]:text-gray-900">Grundinfo</TabsTrigger>
            <TabsTrigger value="rooms" className="data-[state=active]:bg-white data-[state=active]:text-gray-900">Rum</TabsTrigger>
            <TabsTrigger value="details" className="data-[state=active]:bg-white data-[state=active]:text-gray-900">Detaljer</TabsTrigger>
            <TabsTrigger value="location" className="data-[state=active]:bg-white data-[state=active]:text-gray-900">Läge</TabsTrigger>
          </TabsList>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">Objekttyp</FormLabel>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">Adress</FormLabel>
                      <FormControl>
                        <Input placeholder="Ex: Storgatan 1, 12345 Stockholm" className="border-gray-300" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">Område</FormLabel>
                      <FormControl>
                        <Input placeholder="Ex: Vasastan" className="border-gray-300" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">Pris (kr)</FormLabel>
                      <FormControl>
                        <Input type="number" placeholder="Ex: 5500000" className="border-gray-300" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">Månadsavgift (kr)</FormLabel>
                      <FormControl>
                        <Input type="number" placeholder="Ex: 3500" className="border-gray-300" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">Boarea (kvm)</FormLabel>
                      <FormControl>
                        <Input type="number" placeholder="Ex: 85" className="border-gray-300" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">Antal rum</FormLabel>
                      <FormControl>
                        <Input type="number" placeholder="Ex: 3" className="border-gray-300" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">Sovrum</FormLabel>
                      <FormControl>
                        <Input type="number" placeholder="Ex: 2" className="border-gray-300" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">Byggår</FormLabel>
                      <FormControl>
                        <Input type="number" placeholder="Ex: 1998" className="border-gray-300" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">Skick</FormLabel>
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        <FormControl>
                          <SelectTrigger className="border-gray-300">
          ...
          <TabsContent value="rooms" className="space-y-6">
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <h4 className="font-medium text-gray-900">Rum i objektet</h4>
                <Button type="button" onClick={addRoom} variant="outline" size="sm" className="border-gray-300 text-gray-700">
              ...
              {fields.map((field, index) => (
                <div key={field.id} className="border border-gray-200 rounded-lg p-4 bg-white">
                  <div className="flex justify-between items-start mb-4">
                    <h5 className="font-medium text-gray-900">Rum {index + 1}</h5>
                    <Button 
                      type="button" 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-gray-700">Rumstyp</FormLabel>
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            <FormControl>
                              <SelectTrigger className="border-gray-300">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-gray-700">Storlek (kvm)</FormLabel>
                          <FormControl>
                            <Input type="number" placeholder="Ex: 25" className="border-gray-300" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-gray-700">Beskrivning</FormLabel>
                        <FormControl>
                          <Textarea 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">Köksbeskrivning</FormLabel>
                      <FormControl>
                        <Textarea 
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">Badrumsbeskrivning</FormLabel>
                      <FormControl>
                        <Textarea 
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">Golv</FormLabel>
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        <FormControl>
                          <SelectTrigger className="border-gray-300">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">Uppvärmning</FormLabel>
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        <FormControl>
                          <SelectTrigger className="border-gray-300">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-gray-700">Särskilda egenskaper</FormLabel>
                    <FormControl>
                      <Textarea 
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-gray-700">Försäljningsargument</FormLabel>
                    <FormControl>
                      <Textarea 
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">Utsikt</FormLabel>
                      <FormControl>
                        <Input placeholder="Ex: Sjöutsikt, parkutsikt, innergård" className="border-gray-300" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">Kommunikationer</FormLabel>
                      <FormControl>
                        <Input placeholder="Ex: 5 min till t-bana, buss utanför" className="border-gray-300" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-gray-700">Områdesbeskrivning</FormLabel>
                    <FormControl>
                      <Textarea 
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-gray-700">Parkering</FormLabel>
                    <FormControl>
                      <Input placeholder="Ex: Garage i carport, gästparkering" className="border-gray-300" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
        ...
        <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
          <h3 className="font-medium text-gray-900 mb-4">Plattform</h3>
          <FormField
            control={form.control}
            name="platform"
            render={({ field }) => (
