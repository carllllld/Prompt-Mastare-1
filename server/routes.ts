...
const PHRASE_REPLACEMENTS: [string, string][] = [
  ...
  // === KLYSCHORD — bara de som AI överanvänder och som inte tillför fakta ===
  ["fantastisk", "fin"],
  ["perfekt", "bra"],
  ["dröm", ""],
  ["magisk", ""],
  ...
  // Överdrivna adverb — bara de som AI överanvänder
  ["noggrant utvalt", ""],
  ["noggrant utvalda", ""],
  ...
  // Nya förbjudna fraser (andas, genomsyras, faciliteter)
  ["andas lugn", ""],
  ["andas charm", ""],
  ["andas historia", ""],
  ["andas", ""],
    ...
    economics: {
      ...
      ...(fee ? (
        propertyType === "villa" || propertyType === "house" || propertyType === "hus"
          ? { driftkostnad: fee, fee_label: "Driftkostnad", fee_unit: "kr/år" }
          : { avgift: fee, fee_label: "Avgift", fee_unit: "kr/mån" }
      ) : {}),
